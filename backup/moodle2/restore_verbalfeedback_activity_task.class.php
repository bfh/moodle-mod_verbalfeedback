...
class restore_verbalfeedback_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // The verbalfeedback module only has one structure step.
        $this->add_step(new restore_verbalfeedback_activity_structure_step('verbalfeedback_structure', 'verbalfeedback.xml'));
    }
     ...
     * verbalfeedback logs. It must return one array
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('verbalfeedback', 'view', 'view.php?id={course_module}', '{verbalfeedback}');
        $rules[] = new restore_log_rule('verbalfeedback', 'choose', 'view.php?id={course_module}', '{verbalfeedback}');
        $rules[] = new restore_log_rule('verbalfeedback', 'choose again', 'view.php?id={course_module}', '{verbalfeedback}');
        $rules[] = new restore_log_rule('verbalfeedback', 'report', 'report.php?id={course_module}', '{verbalfeedback}');
