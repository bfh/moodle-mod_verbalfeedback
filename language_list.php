...
$pageurl = new moodle_url('/mod/verbalfeedback/language_list.php');
$PAGE->set_url($pageurl);
$PAGE->set_context(context_system::instance());
$PAGE->set_title(get_string('verbalfeedbacklanguages', 'verbalfeedback'));
$PAGE->set_heading(get_string('verbalfeedbacklanguages', 'verbalfeedback'));
$PAGE->set_pagelayout('admin');

echo $OUTPUT->header();

$languagerepository = new language_repository();
$languages = $languagerepository->get_all();

$languagedata = new \mod_verbalfeedback\output\language_list($languages);

$renderer = $PAGE->get_renderer('mod_verbalfeedback');

echo $renderer->render($languagedata);
