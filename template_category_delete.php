...
$pageurl = new moodle_url('/mod/verbalfeedback/template_category_delete.php');
if ($id) {
    $pageurl->param('id', $id);
}
...
$PAGE->set_heading(get_string('deletecategory', 'verbalfeedback'));
$PAGE->set_pagelayout('admin');
$mform = new template_category_delete_form();
...
if ($mform->is_cancelled()) {
    ...
    $templatecategoryrepository->delete_by_id($formdata->id);
    ...
    $viewmodel = template_category_to_view_model($templatecategory);
