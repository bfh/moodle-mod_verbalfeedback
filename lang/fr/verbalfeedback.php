...
$string['defaulttemplate'] = 'Template par défaut';
$string['defaulttemplate_desc'] = 'Le template par défaut à utiliser lors de la création d\'une nouvelle instance de feedback verbal.';
...
$string['notemplateused'] = 'Aucun template utilisé, veuillez aller dans les paramètres pour en sélectionner un.';
...
$string['subratingcopy'] = 'Copier le subrating';
$string['subratingdelete'] = 'Supprimer le subrating';
...
$string['templateused'] = 'Template utilisé';
$string['text'] = 'Text';
