...
$string['defaulttemplate_desc'] = 'Das vorausgewählte Template, das beim Erstellen einer neuen Feedback-Instanz verwendet wird.';
...
$string['notemplateused'] = 'Kein Template verwendet, bitte gehen Sie zu den Einstellungen, um eines auszuwählen.';
...
$string['subratingcopy'] = 'Subrating kopieren';
$string['subratingdelete'] = 'Subrating löschen';
...
$string['templateused'] = 'Verwendetes Template';
$string['text'] = 'Text';
