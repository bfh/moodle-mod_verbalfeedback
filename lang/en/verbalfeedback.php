...
$string['defaulttemplate_desc'] = 'The default template to use when creating a new verbal feedback instance.';
...
$string['notemplateused'] = 'No template used, please go to the settings to select one.';
...
$string['subratingcopy'] = 'Copy subrating';
$string['subratingdelete'] = 'Delete subrating';
...
$string['templateused'] = 'Template used';
$string['text'] = 'Text';
